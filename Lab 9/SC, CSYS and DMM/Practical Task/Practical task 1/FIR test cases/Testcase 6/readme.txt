...
Output should match --> ecg_band_pass_filtered
...
the filtered signal after applying convolution and your output should match ecg_band_pass_filtered file output